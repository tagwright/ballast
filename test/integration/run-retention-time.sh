...
#
# It runs that Go test inside a throwaway container (golang:1.25.14 plus a
...
log "running TestForgetKeepDailyTimeBased in a throwaway golang:1.25.14 + restic container"
